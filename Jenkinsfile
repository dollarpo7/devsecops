...
// Note: getStageResults using rawBuild requires script approval in Jenkins sandbox
// Using simplified approach that tracks failed stage via environment variable
/////// ******************************* Code for fectching Failed Stage Name ******************************* ///////
   ...
   stage('SonarQube - SAST') {
    steps {
      withSonarQubeEnv('SonarQube') {
        sh "mvn clean verify sonar:sonar -Dsonar.projectKey=numeric_app -Dsonar.projectName='numeric_app'"
      }
